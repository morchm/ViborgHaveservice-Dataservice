...
export default function reviewsAdmin(){
     ...
     const { data:dataDELETE, isLoading:isLoadingDELETE, error:errorDELETE, makeRequest:makeRequestDELETE} = useRequestData<ReviewDELETE>();
    ...
    const handleDelete = ( review: Review ) => {
        if(window.confirm("Er du sikker på du vil slette anmeldelsen fra: " + review.author + "?")) {
            makeRequestDELETE("http://localhost:5023/reviews/admin/" + review._id, "DELETE")
        }
    }
    ...
    return(
        ...
        <div className="flex flex-col justify-center max-w-screen-xl m-auto">
            <h1 className="mt-20 mb-10 text-center font-bold text-3xl">Reviews - Admin</h1>

            {/* --- Opret ny anmeldelse --- */}
            <Link href="reviewsCreate" className="mainGreenBackground text-center text-white hover:bg-green-600 w-50 p-3 mb-5 rounded  m-auto">
